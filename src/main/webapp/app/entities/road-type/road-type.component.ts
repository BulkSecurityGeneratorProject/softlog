...
export class RoadTypeComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.roadTypeService
            ...
            .subscribe(
                (res: HttpResponse<IRoadType[]>) => this.paginateRoadTypes(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/road-type'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    private paginateRoadTypes(data: IRoadType[], headers: HttpHeaders) {
