    ...
    describe('VehicleType Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/vehicle-types';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a VehicleType', () => {
                service.create(new VehicleType(null)).subscribe(received => {
            ...
            it('should update a VehicleType', () => {
                service.update(new VehicleType(123)).subscribe(received => {
            ...
            it('should return a VehicleType', () => {
