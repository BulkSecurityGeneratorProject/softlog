...
describe('Service Tests', () => {
    describe('Estimate Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(EstimateService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/estimates';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Estimate', () => {
                service.create(new Estimate(null)).subscribe(received => {
            ...
            it('should update a Estimate', () => {
                service.update(new Estimate(123)).subscribe(received => {
