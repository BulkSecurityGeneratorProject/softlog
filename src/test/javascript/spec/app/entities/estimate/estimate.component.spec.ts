...
import { EstimateComponent } from 'app/entities/estimate/estimate.component';
...
describe('Component Tests', () => {
    describe('Estimate Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.estimates[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
